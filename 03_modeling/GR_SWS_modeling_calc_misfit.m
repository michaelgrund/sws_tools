function GR_SWS_modeling_calc_misfit(modelsin, modrange_low, modrange_high)
...
[RES_split, RES_nulls, RES_stack]=SWS_modelling_read_data(dir_res_split,...
...
% save file
filename=['PLOT_modeling_' staname_split '_' num2str(plot_mod_max) '_best_models_' nameend];
