function PLOT_SCHEMA_2_layers_pdf_version()
...
SL = [20;100;100];   CV = [0;0;0];   EA = [deg2rad(0);deg2rad(60);deg2rad(0)];   colr = [0.5 0.5 0.5];   alph = 0.8;

DrawCuboid(SL, CV, EA, colr, alph)
%
...
[h,xunit,yunit,zunit] = circle3(0,0,-65, 20,'k');
