...
% legend
ll1=plot(-10, -10, 's', 'markeredgecolor', [0 0.4470 0.7410], ...
        'markerfacecolor',[0 0.4470 0.7410],...
        'markersize', 10);

hold on

ll2=plot(-10, -10, 's', 'markeredgecolor', [0.6350 0.0780 0.1840], ...
        'markerfacecolor',[0.6350 0.0780 0.1840],...
        'markersize', 10);
    
hold on    
    
ll3=plot(-10, -10, 's', 'markeredgecolor', [0.9290 0.6940 0.1250],...
