function [RES_split, RES_nulls, RES_stack]=SWS_modeling_read_data(dir_res_split,dir_res_nulls,dir_res_stack,varargin)
%
...
scalingfac=1; % if you want to scale your delay time e.g. for GMT with a specific factor (same for all results)
